...
WL.registerComponent('gamepad-animator', {
    ...
    init: function () {
        if (this._myHandedness == 0) {
            this._myGamepad = LeftGamepad; //@EDIT get gamepad LEFT here based on how you store it in your game
        } else {
            this._myGamepad = RightGamepad; //@EDIT get gamepad RIGHT here based on how you store it in your game
        }
